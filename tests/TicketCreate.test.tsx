...
const mock1Response: Response = {
  text: () =>
    Promise.resolve(
      `<?xml version="1.0" encoding="UTF-8"?><soap:Envelope soap:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><soap:Body><TicketCreateResponse xmlns="http://10.0.0.12/nph-genericinterface.pl/Webservice/SharePointWC"><ArticleID>8620</ArticleID><TicketID>1669</TicketID><TicketNumber>2022091301000051</TicketNumber></TicketCreateResponse></soap:Body></soap:Envelope>`,
    ),
  headers: headers,
  ok: true,
  redirected: false,
